  ...
  const steps = [
    {
      ...
      description: 'Connect your Fathom account with one click. All your recordings sync to 60 automatically and securely.',
      color: 'blue',
    ...
    },
    {
      ...
      icon: TrendingUp,
      title: 'Action',
      description: '60 extracts tasks and to-do items from every call, prioritises them, writes them and syncs them directly into your task manager.',
      color: 'cyan',
