  ...
  return (
    <section id="hero" className="relative pt-32 pb-48 lg:pt-40 lg:pb-56 overflow-hidden bg-gray-50 dark:bg-gray-950 transition-colors duration-300 scroll-mt-24">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full z-0 pointer-events-none">
        <div className="absolute top-20 left-10 w-72 h-72 bg-brand-blue/15 dark:bg-brand-blue/10 rounded-full blur-3xl mix-blend-multiply dark:mix-blend-normal hero-animate-blob" />
        <div className="absolute top-20 right-10 w-72 h-72 bg-brand-violet/15 dark:bg-brand-violet/10 rounded-full blur-3xl mix-blend-multiply dark:mix-blend-normal hero-animate-blob-delay-2" />
        <div className="absolute -bottom-8 left-1/2 w-72 h-72 bg-brand-teal/15 dark:bg-brand-teal/10 rounded-full blur-3xl mix-blend-multiply dark:mix-blend-normal hero-animate-blob-delay-4" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center mb-16 lg:mb-24">
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-lg font-body text-gray-600 dark:text-gray-300 mb-8 leading-relaxed max-w-lg">
  ...
  return (
    <div className="relative w-full max-w-lg">
      ...
      <div className="hidden sm:block absolute right-0 top-20 sm:right-2 lg:-right-12 lg:top-12
                      ...
                      p-3 rounded-lg shadow-xl border border-brand-teal/20
      ...
      <div className="hidden sm:block absolute left-0 bottom-32 sm:left-2 lg:-left-12 lg:bottom-24
                      bg-white dark:bg-gray-800
                      p-3 rounded-lg shadow-xl border border-brand-violet/20
