-- =====================================================
-- NOTES SYSTEM SETUP - CORRECTED VERSION
-- Run this SQL in your Supabase SQL Editor
-- Project: ewtuefzeogytgmsnkpmb
--
-- IMPORTANT COLUMN NAMES:
-- - deals table uses: owner_id AND user_id
-- - contacts table uses: user_id
-- =====================================================
...
-- NOTE: deals table has BOTH owner_id and user_id columns
...
-- NOTE: contacts table uses user_id column
