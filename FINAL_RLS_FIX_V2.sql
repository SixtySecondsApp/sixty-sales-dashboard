-- Final RLS Configuration for suggestions and tasks (V2)
...
-- Drop and recreate INSERT policy to ensure correct configuration
DROP POLICY IF EXISTS "Allow all inserts" ON next_action_suggestions;
