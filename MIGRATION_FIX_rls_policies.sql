-- Fixed version of 20251025203000_action_items_tasks_sync_rls_policies.sql
-- Fix: Changed deals.user_id to deals.owner_id (correct column name)
-- Fix: Removed references to non-existent tasks.user_id column
...
USING (
  ...
  deal_id IN (
    -- FIXED: Changed from user_id to owner_id
