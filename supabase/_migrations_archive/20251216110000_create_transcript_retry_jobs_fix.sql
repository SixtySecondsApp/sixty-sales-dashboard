-- Migration: Create Fathom Transcript Retry Jobs System (Fix for skipped migration)
-- Purpose: This migration was originally dated 2025-01-25 but was skipped because
--          later-dated migrations were already applied. Re-applying with current timestamp.
-- Original: 20250125000001_create_transcript_retry_jobs.sql
-- Date: 2025-12-16
...
DROP POLICY IF EXISTS "Users can view own retry jobs" ON fathom_transcript_retry_jobs;
DROP POLICY IF EXISTS "Service role can manage retry jobs" ON fathom_transcript_retry_jobs;
