-- ============================================================================
-- Fix AI Prompt Templates Table
-- ============================================================================
-- This migration fixes the ai_prompt_templates table by dropping and recreating
-- it with the correct schema including organization_id column.
-- ============================================================================

-- Drop existing objects (in correct order due to dependencies)
DROP FUNCTION IF EXISTS save_prompt_template CASCADE;
DROP FUNCTION IF EXISTS get_prompt_template CASCADE;
DROP FUNCTION IF EXISTS reset_prompt_to_default CASCADE;

DROP TABLE IF EXISTS ai_prompt_template_history CASCADE;
DROP TABLE IF EXISTS ai_prompt_templates CASCADE;

-- Recreate the ai_prompt_templates table with correct schema
...
CREATE INDEX idx_ai_prompt_templates_category
  ON ai_prompt_templates(category);

CREATE INDEX idx_ai_prompt_templates_org_category
  ON ai_prompt_templates(organization_id, category);

CREATE INDEX idx_ai_prompt_templates_user_category
  ON ai_prompt_templates(user_id, category);

CREATE INDEX idx_ai_prompt_templates_public_category
...
CREATE INDEX idx_ai_prompt_template_history_template
