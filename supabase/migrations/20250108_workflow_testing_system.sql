...
-- Complete database schema for three-mode execution, type system, and time-travel debugging
...
CREATE TABLE IF NOT EXISTS scenario_fixtures (
  ...
  node_fixtures JSONB DEFAULT '[]', -- Array of fixture IDs to use
...
-- Grant permissions (customize based on your auth setup)
