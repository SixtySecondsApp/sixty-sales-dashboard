...
-- Tracks key user activation milestones including North Star: "First Summary Viewed"
...
-- 'fathom_connected' - Fathom integration connected
-- 'first_meeting_synced' - First meeting synced
-- 'first_summary_viewed' - NORTH STAR - First summary viewed
-- 'first_action_item_viewed' - Viewed action items
-- 'first_ai_question_asked' - Asked AI a question
-- 'first_proposal_generated' - Generated a proposal
-- 'subscription_started' - Started paid subscription
...
CREATE POLICY "activation_events_service_role" ON user_activation_events
  FOR ALL
...
-- 6. Comments
-- ============================================================================
COMMENT ON TABLE user_activation_events IS 'Detailed activation event log for tracking user journey milestones';
COMMENT ON VIEW activation_funnel_metrics IS 'Aggregated activation funnel metrics for Platform Admin dashboard';
