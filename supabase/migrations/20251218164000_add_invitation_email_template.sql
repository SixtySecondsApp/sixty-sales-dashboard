-- ============================================================================
-- ADD WAITLIST INVITATION EMAIL TEMPLATE
-- Template for sending password-based invitations to waitlist users
-- Uses same dark mode styling as waitlist_welcome and magic_link_waitlist
-- ============================================================================

-- Insert waitlist invitation template
...
<head>
  ...
  <title>You''re Invited to Early Access</title>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" class="email-container" style="max-width: 600px; width: 100%; background-color: #111827 !important; border-radius: 16px; overflow: hidden; border: 1px solid #374151 !important;">
          ...
          <tr style="background-color: #111827 !important;">
            <td class="email-header" style="padding: 48px 40px 32px; text-align: center; background-color: #111827 !important; background: linear-gradient(135deg, #111827 0%, #1F2937 100%) !important;">
              ...
              <h1 class="email-title" style="color: #FFFFFF !important; -webkit-text-fill-color: #FFFFFF !important; font-size: 28px; font-weight: 700; margin: 0 0 12px 0; line-height: 1.2; letter-spacing: -0.02em;">You''re Invited! 🎉</h1>
              <p class="email-subtitle" style="color: #F3F4F6 !important; -webkit-text-fill-color: #F3F4F6 !important; font-size: 18px; margin: 0; line-height: 1.5; font-weight: 400;">Your Early Access is ready!</p>
            </td>
          </tr>
          ...
          <tr style="background-color: #111827 !important;">
            <td class="email-content" style="padding: 40px 40px; background-color: #111827 !important;">
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 32px;">
                <tr>
                  <td>
                    <p class="email-welcome-text" style="color: #F3F4F6 !important; -webkit-text-fill-color: #F3F4F6 !important; font-size: 16px; line-height: 1.7; margin: 0 0 20px 0; text-align: center;">Hi {{user_name}}, you''ve been approved for Early Access! Click the button below to create your password and unlock AI-powered sales intelligence.</p>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 32px;">
                <tr>
                  <td align="center" style="padding-bottom: 24px;">
                    <a href="{{invitation_url}}" class="email-button" style="display: inline-block; padding: 14px 32px; background-color: #10B981 !important; background: linear-gradient(135deg, #10B981 0%, #059669 100%) !important; color: #FFFFFF !important; -webkit-text-fill-color: #FFFFFF !important; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.3);">Set Up Your Password</a>
                  </td>
                </tr>
              </table>
              ...
              <p style="margin: 0 0 32px 0; font-size: 12px; color: #10B981 !important; text-align: center; word-break: break-all; background-color: #1F2937 !important; padding: 12px 16px; border-radius: 8px;">{{invitation_url}}</p>
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                      <tr>
                        ...
                        <td style="font-size: 13px; color: #D1D5DB !important; line-height: 1.5;">
                          <strong>Security notice:</strong> This invitation expires in 7 days and can only be used once. If you didn''t request access, you can safely ignore this email.
                        </td>
                      </tr>
                    </table>
                  </td>
...
Hi {{user_name}}, you''ve been approved for Early Access! Click the link below to create your password and unlock AI-powered sales intelligence.
...
Security notice: This invitation expires in 7 days and can only be used once.

© 2025 Sixty seconds Ltd - 60 AI Sales Assistant',
    '{"invitation_url": "invitation_url", "user_name": "user_name", "user_email": "user_email", "full_name": "full_name", "company_name": "company_name"}'::jsonb,
    true
  )
