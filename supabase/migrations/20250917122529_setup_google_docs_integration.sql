-- Setup Google Docs integration database components
...
DROP POLICY IF EXISTS "Users can view their own meeting documents" ON meeting_documents;
...
DROP POLICY IF EXISTS "Users can insert their own meeting documents" ON meeting_documents;
...
DROP POLICY IF EXISTS "Users can update their own meeting documents" ON meeting_documents;
