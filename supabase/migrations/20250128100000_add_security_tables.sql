-- Add Security Infrastructure Tables
-- Migration: 20250128100000_add_security_tables
-- Purpose: Add cost tracking and security event logging
-- Created: 2025-01-28

-- ============================================================================
-- Cost Tracking Table (for monitoring and rate limiting)
-- ============================================================================
...
COMMENT ON SCHEMA public IS 'Security infrastructure tables added: 20250128100000';
