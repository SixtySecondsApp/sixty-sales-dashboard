-- Migration: Add save_compiled_organization_skill function
-- Purpose: Function to save compiled skills from edge function
-- Date: 2026-01-01
...
-- =============================================================================
-- Function: Get skills needing recompile
