...
const detailedPlans: IntegrationPlan[] = [
  ...
  // =====================================================
  {
    ...
    category: 'CRM',
    logo: 'hubspot',
    useCase: 'Bi-directional sync of contacts, deals, activities, and tasks',
    useCaseDetails: [
    ...
    whatsPossible: 'Full CRUD on all CRM objects, associations, timeline events, batch operations',
    limitations: '100 requests/10 seconds rate limit',
    dataFlows: [
