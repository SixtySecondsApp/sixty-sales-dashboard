      ...
      <div className="relative w-full max-w-md bg-gray-900 rounded-lg shadow-xl border border-gray-800">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-white">Moving to Opportunity Stage</h2>
        ...
        <div className="p-6">
          <div className="mb-6">
            <p className="text-white font-medium mb-2">Have you sent a proposal to this client?</p>
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-white font-medium">Yes, proposal sent</p>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-white font-medium">No, preparing proposal</p>
                  <p className="text-sm text-gray-400 mt-1">
        ...
        <div className="flex gap-3 p-6 border-t border-gray-800">
          ...
          <button
            ...
            className="flex-1 px-4 py-2 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-700 disabled:cursor-not-allowed text-white rounded-lg transition-colors font-medium"
          >
            Confirm & Move
          </button>
        </div>
