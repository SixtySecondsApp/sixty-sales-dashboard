...
export function LeadAnalyticsCard() {
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800/60 dark:bg-gray-950/40">
      ...
      <div className="mt-6 overflow-hidden rounded-xl border border-gray-100 dark:border-gray-800/60">
