...
const ViewModeToggle: React.FC<ViewModeToggleProps> = ({
  ...
  return (
    <div className="flex items-center bg-gray-100 dark:bg-gray-800/50 rounded-lg p-1 relative">
      {/* Active background */}
      <motion.div
        className="absolute bg-emerald-50 dark:bg-emerald-500/20 rounded transition-all duration-300"
        animate={{
