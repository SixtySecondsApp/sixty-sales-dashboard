      ...
      <div className="p-3 space-y-3 bg-white dark:bg-[#1e1e1e]">
        {data.config?.content && (
          <div className="space-y-1">
            <label className="text-[10px] font-medium text-gray-500 dark:text-zinc-500 uppercase tracking-wider">Content</label>
        ...
        {isConfigured && data.config && (
          <div className="grid grid-cols-2 gap-2 text-[10px] text-gray-500 dark:text-zinc-500 pt-2 border-t border-gray-200 dark:border-zinc-800">
            <div className="flex flex-col gap-1">
              ...
              <span className="text-gray-700 dark:text-zinc-300">{getDocTypeName()}</span>
            </div>
            <div className="flex flex-col gap-1">
              <span className="uppercase tracking-wider">Sharing</span>
              <span className="text-gray-700 dark:text-zinc-300">{data.config.shareWith?.length || 0} user{data.config.shareWith?.length !== 1 ? 's' : ''}</span>
            </div>
          </div>
        )}
      </div>
