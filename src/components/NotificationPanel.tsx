...
export function NotificationPanel({ onClose }: NotificationPanelProps) {
  ...
  return (
    <div className="w-96 max-h-[600px] bg-gray-900 border border-gray-800 rounded-lg shadow-2xl overflow-hidden flex flex-col">
      {/* Header */}
      <div className="p-4 border-b border-gray-800">
        ...
        {/* Filter Tabs */}
        <div className="flex gap-1 bg-gray-800/50 p-1 rounded">
          <button
      ...
      {notifications.length >= 20 && (
        <div className="p-3 border-t border-gray-800">
          <button
            onClick={loadMore}
            className="w-full px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-gray-800 rounded transition-colors"
          >
