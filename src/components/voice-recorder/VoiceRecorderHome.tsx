 ...
 * Two-column layout on desktop: Recording controls left, recordings list right
  ...
  return (
    <div className={cn('min-h-full', className)}>
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="lg:w-[340px] lg:shrink-0 p-6 lg:p-8 lg:border-r border-gray-200 dark:border-gray-700/50">
          {/* Header */}
          ...
          <div className="mt-6">
            ...
            >
              <div className="relative bg-[#37bd7e] hover:bg-[#2da76c] rounded-3xl p-6 flex items-center justify-center gap-4 transition-all group-hover:scale-[1.02] group-active:scale-[0.98] shadow-lg shadow-[#37bd7e]/20">
        ...
        <div className="flex-1 min-w-0 p-6 lg:p-8 bg-gray-50/50 dark:bg-gray-900/30">
          ...
          <div>
            {recentRecordings.length === 0 ? (
              <div className="p-6 rounded-2xl bg-white dark:bg-gray-900/80 dark:backdrop-blur-sm border border-gray-200 dark:border-gray-700/50 text-center shadow-sm dark:shadow-none">
