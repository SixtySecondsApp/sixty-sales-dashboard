    ...
    <section className="relative py-24 lg:py-32 bg-gradient-to-b from-[#0a0d14] to-[#0d1117] overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <div className="relative p-8 lg:p-12 rounded-3xl bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20 overflow-hidden">
            {/* Decorative Elements */}
            ...
            <div className="relative grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                <motion.div
                  ...
                  className="rounded-2xl overflow-hidden border border-white/10 bg-gray-900/80 backdrop-blur-xl shadow-2xl"
                >
                  <div className="p-4 border-b border-white/10 bg-black/30">
                    <div className="flex items-center gap-3">
                      <div className="w-3 h-3 rounded-full bg-emerald-500" />
                      <span className="text-sm text-emerald-400 font-medium">Connected to Fathom</span>
                    </div>
                  </div>
                  <div className="p-6 space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-400">Recordings synced</span>
                    ...
                    <div className="pt-4 border-t border-white/10">
                      <div className="text-xs text-gray-500 mb-2">Recent imports</div>
            ...
            >
              <div className="text-center">
                <div className={`text-lg font-semibold mb-1 ${
                  integration.status === 'live' ? 'text-white' : 'text-gray-500'
                }`}>
                  {integration.name}
                </div>
                <div className={`text-xs ${
                  integration.status === 'live' ? 'text-emerald-400' : 'text-gray-600'
                }`}>
