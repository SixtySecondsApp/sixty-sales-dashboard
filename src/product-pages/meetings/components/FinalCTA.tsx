  ...
  return (
    <section className="relative py-24 lg:py-32 bg-[#0a0d14] overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {/* Card Background */}
          <div className="absolute inset-0 bg-gradient-to-br from-blue-600/20 via-purple-600/10 to-emerald-600/20 backdrop-blur-xl" />
          ...
          <div className="relative p-8 lg:p-12 text-center">
            ...
            >
              ...
              <span className="text-blue-300 text-sm font-medium">Limited Time: Extended 14-Day Trial</span>
            </motion.div>
        ...
        >
          <div className="p-6 rounded-2xl bg-gray-900/50 border border-white/10 hover:border-white/20 transition-all duration-300">
            <h3 className="text-lg font-semibold text-white mb-2">For Sales Teams</h3>
