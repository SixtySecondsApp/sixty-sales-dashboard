...
export function HeroSectionV4() {
  ...
  return (
    <section className="relative pt-32 pb-0 lg:pt-40 lg:pb-0 overflow-hidden bg-slate-50 dark:bg-gray-950 transition-colors duration-300">

      {/* Background Decor */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full z-0 pointer-events-none">
        <div className="absolute top-20 left-10 w-72 h-72 bg-blue-400/20 dark:bg-blue-600/10 rounded-full blur-3xl mix-blend-multiply dark:mix-blend-normal hero-animate-blob" />
        <div className="absolute top-20 right-10 w-72 h-72 bg-purple-400/20 dark:bg-purple-600/10 rounded-full blur-3xl mix-blend-multiply dark:mix-blend-normal hero-animate-blob-delay-2" />
        <div className="absolute -bottom-8 left-1/2 w-72 h-72 bg-pink-400/20 dark:bg-pink-600/10 rounded-full blur-3xl mix-blend-multiply dark:mix-blend-normal hero-animate-blob-delay-4" />
      </div>

      {/* Bottom gradient fade to dark */}
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-b from-transparent via-slate-100/50 to-[#0a0d14] dark:from-transparent dark:via-gray-900/50 dark:to-[#0a0d14] z-0 pointer-events-none" />
...
function WorkflowVisual() {
  return (
    <div className="relative w-full max-w-md">
      {/* Main Dashboard Card */}
      <div className="relative w-full bg-white dark:bg-gray-900 rounded-2xl shadow-2xl dark:shadow-black/50 border border-slate-200 dark:border-gray-700/50 overflow-hidden transform transition hover:scale-[1.01] duration-500">

        {/* Header: Call Status */}
        <div className="bg-slate-50 dark:bg-gray-800/50 px-6 py-4 border-b border-slate-100 dark:border-gray-700/50 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="w-2 h-2 bg-red-500 rounded-full relative hero-pulse-dot"></div>
            <span className="font-semibold text-slate-700 dark:text-gray-200">Completed: Discovery Call</span>
          </div>
          <div className="text-xs font-mono text-slate-400 dark:text-gray-500">00:14:23</div>
        </div>
        ...
        <div className="p-6 space-y-0">
          ...
          <div className="space-y-4 mb-2 hero-animate-step-1">
            <div className="flex gap-3">
              ...
              <div className="bg-slate-50 dark:bg-gray-800 p-3 rounded-lg rounded-tl-none text-sm text-slate-600 dark:text-gray-300 w-full">
            ...
            <div className="flex gap-3 flex-row-reverse">
              ...
              <div className="bg-blue-50 dark:bg-blue-500/10 p-3 rounded-lg rounded-tr-none text-sm text-slate-800 dark:text-gray-200 w-full border border-blue-100 dark:border-blue-500/20">
          ...
          <div className="flex justify-center my-1 hero-connector-line-2">
            <div className="w-0.5 bg-slate-200 dark:bg-gray-600 h-6 rounded-full"></div>
          </div>

          {/* 3. The Result (The Artifact) */}
          <div className="hero-animate-step-3">
            <div className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-xl p-4 shadow-lg relative overflow-hidden group">
              {/* Teams Badge */}
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-slate-900 dark:text-gray-100 text-sm">Acme_Proposal_v1.pdf</h4>
                  <p className="text-xs text-slate-500 dark:text-gray-400 mt-1 mb-3">Generated from template "Standard Enterprise"</p>

                  <div className="flex gap-2">
                    <button className="text-xs bg-slate-900 dark:bg-gray-700 text-white px-3 py-1.5 rounded-md hover:bg-slate-800 dark:hover:bg-gray-600 transition">Review</button>
                    <button className="text-xs bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-600 text-slate-600 dark:text-gray-300 px-3 py-1.5 rounded-md hover:bg-slate-50 dark:hover:bg-gray-700 transition">Edit</button>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="h-1 w-full bg-slate-100 dark:bg-gray-800">
          <div className="h-full hero-animate-scan w-full"></div>
        </div>
      </div>

      {/* Floating Elements for Depth - Hidden on mobile to prevent overflow */}
      <div className="hidden lg:block absolute -right-16 top-20 bg-white dark:bg-gray-800 p-3 rounded-xl shadow-xl border border-slate-100 dark:border-gray-700 hero-animate-float">
        <img src="https://upload.wikimedia.org/wikipedia/commons/4/44/Microsoft_logo.svg" className="w-6 h-6" alt="Microsoft" />
      </div>
      <div className="hidden lg:block absolute -left-20 bottom-32 bg-white dark:bg-gray-800 p-3 rounded-xl shadow-xl border border-slate-100 dark:border-gray-700 hero-animate-float-delay">
